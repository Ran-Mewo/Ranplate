...
Also could look in this [class](https://github.com/Ran-helo/Ranplate/tree/main/common/src/main/java/net/examplemod/ExampleMod.java) if you need an example of how to use it!
